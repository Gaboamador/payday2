...
<div className="buttons">
          <Button className="randomizeButton" onClick={handleRandomizeDifficulty}>RANDOMIZE DIFFICULTY</Button>
          <Button className="eyeSlashButton reset" onClick={() => handleResetDifficulty()}>RESET DIFFICULTY</Button>
  ...
  <div className="randomBuildContainer backgroundImage">
        <div className="buttons">
          ...
          <Button className="eyeSlashButton reset" onClick={() => handleResetBuild()}>RESET BUILD</Button>
  ...
  <div className="randomBuildContainer backgroundImage">
        <div className="buttons">
          ...
          <Button className="eyeSlashButton reset" onClick={() => handleResetHeist()}>RESET HEIST</Button>
  ...
  <div className="randomBuildContainer backgroundImage">
        <div className="buttons">
          <Button className="randomizeButton" onClick={handleRandomizeProfile}>RANDOMIZE PROFILE</Button>
          <Button className="eyeSlashButton reset" onClick={() => handleResetProfile()}>RESET PROFILE</Button>
